...
source3 = VideoReader('./SIFT/campus4-c2.mp4');
source4 = VideoReader('./SIFT/campus4-c2.mp4');
...
det1=imdilate(det1,se1); %ͼ������
det1=bwareaopen(det1,1000);%ȥ��ͼ�������С�� 500 ������
det2(det2<theld)=0;
det2(det2>=theld)=1; 
sel2=strel('diamond', 10);
det2=imdilate(det2,sel2); %ͼ������
det2=bwareaopen(det2,1000);
det3(det3<theld)=0;
det3(det3>=theld)=1; 
se3=strel('diamond', 10);
det3=imdilate(det3,se3); %ͼ������
det3=bwareaopen(det3,1000);%ȥ��ͼ�������С�� 500 ������
det4(det4<theld)=0;
det4(det4>=theld)=1; 
se4=strel('diamond', 10);
det4=imdilate(det4,se4); %ͼ������
det4=bwareaopen(det4,1000);%ȥ��ͼ�������С�� 500 ������
% % % det2= imfill(det2,'holes');%��ԭͼ���׶�
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Ŀ �� �ָ�%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
box1(i).BoundingBox(3)=n-box1(i).BoundingBox(1); end
...
box2(i).BoundingBox(3)=n-box2(i).BoundingBox(1); end
if box2(i).BoundingBox(2)+box2(i).BoundingBox(4)>m
box2(i).BoundingBox(4)=m-box2(i).BoundingBox(2); end
end
for i=1:length(box3)
...
box4(i).BoundingBox(3)=n-box4(i).BoundingBox(1); end
if box4(i).BoundingBox(2)+box4(i).BoundingBox(4)>m
box4(i).BoundingBox(4)=m-box4(i).BoundingBox(2); end
end
if length(box1)>0
if bFirst==1
boxOld1=box1;
...
boxOld3=box3;
bFirst3=0; else
[boxOld3,num] = RectAna(boxOld3, box3,det3,m,n); end
else boxOld3=box3; 
end
if length(box4)>0
if bFirst4==1
